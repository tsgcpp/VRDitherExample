Shader "VRDitherExample/VRM10/Universal Render Pipeline/MToon10 Dither"
{
    Properties
    {
        // Custom
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment MToonDitherFragment

            #define MTOON_URP

            #include "Packages/com.vrmc.vrmshaders/VRM10/MToon10/Resources/VRM10/vrmc_materials_mtoon_forward_vertex.hlsl"
            #include "./vrmc_materials_mtoon_forward_dither_fragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma fragment MToonShadowCasterDitherFragment

            #define MTOON_URP
            
            #include "Packages/com.vrmc.vrmshaders/VRM10/MToon10/Resources/VRM10/vrmc_materials_mtoon_shadowcaster_vertex.hlsl"
